...
export default function ShareEarnConfig() {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen pb-32 font-sans selection:bg-primary/20">
      ...
      <header className="bg-[#fff4f6] w-full sticky top-0 z-50 border-b border-primary/10">
      ...
      <main className="w-full max-w-2xl lg:max-w-3xl mx-auto px-4 sm:px-6 py-6 pb-40 space-y-6">
        {toastMsg && (
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full py-4 sm:py-5 rounded-2xl bg-[#25D366] text-white font-black text-base sm:text-lg flex items-center justify-center gap-3 shadow-[0_12px_40px_rgba(37,211,102,0.3)] hover:opacity-95 active:scale-[0.98] transition-all cursor-pointer"
          >
            ...
            Share to WhatsApp with My Margin
          </button>
        </div>
      </main>
