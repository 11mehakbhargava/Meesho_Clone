...
const EarningsDashboard1 = () => {
  ...
  return (
    <div className="bg-background text-on-surface min-h-screen pb-32 font-sans selection:bg-primary/20">
      ...
      {/* BottomNavBar - Full Width with evenly distributed icons */}
      <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 sm:px-12 md:px-24 lg:px-48 pb-6 pt-3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-50 rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)] border-t border-slate-100 dark:border-slate-800">
        <button
          type="button"
          onClick={() => navigate("/reseller-home")}
          className="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 active:scale-90 transition-all duration-200 cursor-pointer"
        >
          <span className="material-symbols-outlined">storefront</span>
          <span className="font-sans text-[10px] font-semibold uppercase tracking-wider mt-1">
            Shop
          </span>
        </button>
        <button
          ...
          className="flex flex-col items-center justify-center text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-900/30 rounded-2xl px-4 py-1 active:scale-90 transition-all duration-200 cursor-pointer"
        >
          <span
